...
--
-- Host: localhost
-- Generation Time: Jan 05, 2021 at 11:35 AM
...
('root', '[{\"db\":\"simice\",\"table\":\"user\"},{\"db\":\"simice\",\"table\":\"user_sub_menu\"},{\"db\":\"simice\",\"table\":\"user_access_menu\"},{\"db\":\"simice\",\"table\":\"user_menu\"},{\"db\":\"penjualan\",\"table\":\"pengguna\"},{\"db\":\"simice\",\"table\":\"barang\"},{\"db\":\"simice\",\"table\":\"order\"},{\"db\":\"simice\",\"table\":\"orderan\"},{\"db\":\"simice\",\"table\":\"ORDERAN\"},{\"db\":\"simice\",\"table\":\"user_role\"}]');
...
('root', '2021-01-05 10:34:33', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `simice`
--
CREATE DATABASE IF NOT EXISTS `simice` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `simice`;
...
INSERT INTO `order` (`id_order`, `id_barang`, `jumlah`) VALUES
(1, 11, 2),
(2, 22, 3),
(3, 11, 3),
(4, 11, 2);
...
(7, 'Irfan Fanani', 'irfanfananim119@gmail.com', 'default.jpg', '$2y$10$jtDDHYxnqVPYlMIQgpYjwuq0vpGOEXBPM3fMlnDGg6A4BX5h.qtHa', 2, 1, 1603775971),
(8, 'Admin', 'admin@simice.id', 'default.jpg', '$2y$10$16shYDyv2KQx2JBURefKyeSFw8J7bo0AR8RposkDG4HsqzEUQ.fIC', 1, 1, 1603799243),
(9, 'Bima Saputra', 'bimasaputra@gmail.com', 'default.jpg', '$2y$10$mfmA9dG8o/768iQaIRHgB..hRxLexxwa1HmyKxbUYZ4futzYiSQg2', 2, 1, 1609748025);
